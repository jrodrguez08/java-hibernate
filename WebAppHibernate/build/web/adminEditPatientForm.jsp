<%-- 
    Document   : adminEditPatientForm
    Created on : May 23, 2016, 9:43:05 AM
...
<html>
    <head>
        ...
        <title>Administrador - Editar Paciente</title>
    </head>
    <%
        String userId = request.getSession().getAttribute("patientToEdit").toString();
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form id="editPatient" action="EditPatientFormServlet" method="post">
                                ...
                                <div class="form-group hide">
                                    ...
                                    <input type="text" class="form-control" id="userId" name="userId" value="${patientEditable.userId}" placeholder="Usuario">
                                </div>
                                <div class="form-group">
