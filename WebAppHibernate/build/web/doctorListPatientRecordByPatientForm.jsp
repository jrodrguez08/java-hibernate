<%-- 
    Document   : doctorListPatientRecordByPatientForm
    Created on : 26/05/2016, 10:14:00 PM
    Author     : Andrés
--%>
...
<html>
    ...
    <%
        ...
        List<Patientappointments> patientAppointments = service.getAllPatientsAppointmentsByPatientId(request.getSession().getAttribute("patientRecordToEdit").toString());
