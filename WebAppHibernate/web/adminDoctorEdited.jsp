<%-- 
    Document   : adminDoctorEdited
    Created on : May 13, 2016, 1:38:52 PM
...
<html>
    <head>
        ...
        <title>Administrador - Editar Doctor</title>
    </head>
    <body>
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="col-md-12">
                    <div class="row">
                        <h1 class="dashboard-title">M&eacute;dico editado correctamente</h1>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
